    ...
    <AnimatePresence>
      {visible && (
        <motion.div
          ...
          className={`fixed top-5 lg:w-fit left-1/2 transform -translate-x-1/2 z-[9999] px-6 py-4 rounded-lg shadow-lg w-[20rem] max-w-full flex items-center gap-4 text-white ${alertColors[type]}`}
        >
