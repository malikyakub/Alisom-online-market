      ...
      <div className="relative bg-white rounded-lg shadow-xl p-6 w-full max-w-md">
        ...
        <div className="flex space-x-2">
          <button
            ...
            className="flex-grow min-w-[140px] bg-blue-500 text-white font-bold py-2 px-4 rounded hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed"
            disabled={isLoading}
          >
          ...
          <button
            type="button"
            onClick={handleDeny}
            className="flex-grow min-w-[140px] bg-red-500 text-white font-bold py-2 px-4 rounded hover:bg-red-700 disabled:opacity-50 disabled:cursor-not-allowed"
            disabled={isLoading}
          >
