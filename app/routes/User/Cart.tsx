...
const cartItems = [
  ...
  export default function Cart() {
    ...
    return (
        <div className="flex flex-col p-8 gap-8 bg-gray-100 min-h-screen">
        ...
        <div className="w-full md:w-2/3">
          ...
          <div className="flex flex-col gap-6">
            {cartItems.map((item, index) => (
              <div
                key={index}
                className="grid grid-cols-4 items-center bg-white p-4 rounded-md shadow-sm"
              >
                {/* Product Column */}
          ...
          <div className="flex justify-between mt-6">
            <button className="px-6 py-2 border rounded text-sm text-gray-700 hover:bg-gray-100">
              Return to Shop
            </button>
